        ...
        <div class="col-sm-12">
            <section class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="alert bg-primary" role="alert"><em class="fa fa-comment mr-2"></em> Gelir - Gider Raporlarınıza daha geniş bir şekilde bu bölümden bakabilirsiniz.<a href="#" class="float-right"><em class="fa fa-remove"></em></a></div>
