                    ...
                    <div class="card mb-4">
                        <div class="card-block">
                            ...
                            <div class="dropdown card-title-btn-container">
                                <a href="{{route('gelir.create')}}"><button class="btn btn btn-primary" type="button"><em class="fa fa-plus"></em> GELİR EKLE</button></a>
                            </div>
                                ...
                                <table id="example" class="table table-striped" cellspacing="0" width="100%">
                                    ...
                                    @endphp
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$l->gelir_adi}}</td>
                                            <td>{{$l->gelir_tutari}} ₺</td>
                                            <td>{{$tarih}}</td>
                                            <td>

                                                {!! Form::open(['route' => ['gelir.destroy','id' => $l->id], 'method' => 'DELETE']) !!}
                                                <button class="btn btn-sm btn-link" type="submit"><em class="fa fa-plus"></em> GELİR SİL</button>
                                                {!! Form::close() !!}
                                            </td>
