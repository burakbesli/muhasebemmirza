...
<head>
    ...
    <title>MuhasebemMirza Login</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>MuhasebemMirza</strong> Giriş</h1>
                    ...
                    <div class="form-bottom">
                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="text" name="email" placeholder="email..." class="form-username form-control" required>
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" type="password" name="password" placeholder="şifre..." class="form-password form-control" required>
