                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card mb-4">
                        <div class="card-block">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">BU BÖLÜMDEN FİNANSAL GİDER EKLEYEBİLİRSİNİZ.</h6>

                            <form class="form-horizontal" action="{{route('gider.store')}}" method="post">
                                {{ csrf_field() }}
                                <fieldset>
                                    <!-- Name input-->
                                    <div class="form-group">
                                        <label class="col-12 control-label no-padding" for="name">Gider Adı</label>

                                        <div class="col-12 no-padding">
                                            <input id="gider_adi" name="gider_adi" type="text" class="form-control" required>
                                        </div>
                                    </div>

                                    <!-- Email input-->
                                    <div class="form-group">
                                        <label class="col-12 control-label no-padding" for="email">Gider Tutarı</label>

                                        <div class="col-12 no-padding">
                                            <input id="gider_tutari" name="gider_tutari" type="number"  class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-12 widget-right no-padding">
                                            <button type="submit" class="btn btn-primary btn-md float-right">GİDER Ekle</button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
